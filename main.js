...
const OGE_2_HELLO = (x, y) => `Hello! It's the electronic assistant of the ${x}. We kindly ask you to take part in our survey. We need to find out how ${y}. Please answer six questions. The survey is anonymous - you don't have to give your name. So, let's get started.`;
